...
public class TileLibary {
    ...
    public static final Tile T_TEMPLATE = new Tile(Arrays.asList(
            new Position(0, 0),
            new Position(0, 1),
            new Position(0, 2),
            new Position(1, 1)
    ...
    public static final Tile T_TEMPLATE_REVERSE = new Tile(Arrays.asList(
            new Position(0, 0),
            new Position(0, 1),
            new Position(0, 2),
            new Position(1, -1)
    ));
    public static final Tile L_TEMPLATE_REVERSE = new Tile(Arrays.asList(
            new Position(0, 0),
            new Position(1, 0),
            new Position(1, 1),
            new Position(1, 2)
    ...
    public static final Tile S_TEMPLATE_REVERSE = new Tile(Arrays.asList(
            new Position(0, 0),
            new Position(0, 1),
            new Position(1, 1),
            new Position(1, 2)
