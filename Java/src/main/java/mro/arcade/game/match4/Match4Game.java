...
public class Match4Game {
    ...
    Match4BoardFrame match4BoardFrame = new Match4BoardFrame(new Size(12, 12), new Position(3, 0), new Color(10, 10, 10));
    ...
    public void run() throws InterruptedException {
        ...
        while (!win) {
            ...
            match4Board.insertTileToField(TileLibary.DOT_TEMPLATE, columnInsertCoinTo);
            render();
